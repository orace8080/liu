...
public class ElasticSearchHandler {
    ...
    public void createIndexResponse(String indexname, String type, List<String> jsondata){
        ...
        IndexRequestBuilder requestBuilder =ESTools.client.prepareIndex(indexname, type).setRefresh(true);
    ...
    public IndexResponse createIndexResponse(String indexname, String type,String jsondata){
        IndexResponse response = ESTools.client.prepareIndex(indexname, type)
            .setSource(jsondata)
            .execute()
            .actionGet();
        return response;
    ...
    public List<Medicine>  searcher(QueryBuilder queryBuilder, String indexname, String type){
        ...
        SearchResponse searchResponse = ESTools.client.prepareSearch(indexname).setTypes(type)
