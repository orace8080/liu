...
//  private static final String CLUSTER_NAME = "cluster_name";  
    public static final String CLUSTER_NAME = "globalhawk-es-cluster"; //实例名称
...
//    }  
    ...
    public static void main(String args[]){
        ...
        .setQuery(QueryBuilders.matchQuery("message", "request")) //在这里"message"是要查询的field,"Accept"是要查询的内容
        .setFrom(0)
        .setSize(10)
        .setExplain(true)
        .execute()
